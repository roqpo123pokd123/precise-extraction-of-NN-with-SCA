...
def main():
    ...
    model = model_utils.get_net(model_name, n_output_classes=num_classes, pretrained=pretrained_bool, device=device)
    ...
    train_sec = time.perf_counter()

    print("#########victim train time#############", train_sec-sec)
    # Store arguments
