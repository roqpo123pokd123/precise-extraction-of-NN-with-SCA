...
class Blackbox(object):
    ...
    @classmethod
    def from_modeldir(cls, model_dir, model_name, num_class, device=None, output_type='probs'):
        device = torch.device('cuda') if device is None else device

        # What was the model architecture used by this model?
        # Instantiate the model
        model = model_utils.get_net(model_name=model_name, n_output_classes=num_class, pretrained=False,device=device)
